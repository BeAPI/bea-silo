...
'use strict';var _createClass=function(){function a(a,b){for(var c,d=0;d<b.length;d++)c=b[d],c.enumerable=c.enumerable||!1,c.configurable=!0,'value'in c&&(c.writable=!0),Object.defineProperty(a,c.key,c)}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}();Object.defineProperty(exports,'__esModule',{value:!0});require('../polyfill/forEach');var _utils=require('./utils');function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError('Cannot call a class as a function')}var Silo=function(){function a(b,c,d){var e=this,f=!!(3<arguments.length&&void 0!==arguments[3])&&arguments[3],g=arguments[4];_classCallCheck(this,a),this.name=b,this.opts=c,this.container=d,this.preview=f,this.terms=bea_silo.objects[this.name].terms,this.baseSlug=bea_silo.objects[this.name].base_slug,this.scrollable=g,this.init(),this.container.addEventListener('click',this.handleClick.bind(this)),window.onpopstate=function(){e.container.innerHTML='',e.init()}}return _createClass(a,null,[{key:'bind',value:function bind(b,c){var d=!(2<arguments.length&&void 0!==arguments[2])||arguments[2];document.querySelectorAll(b).forEach(function(b){var e=b.dataset.preview,f=b.dataset.name,g=new a(f,c,b,e,d);return g})}}]),_createClass(a,[{key:'checkUrl',value:function checkUrl(){for(var a=this,b=window.location.href,c=this.terms.filter(function(a){return a.term_link===b})[0],d=[],e=function(b,e){if(!d.length){var f=a.terms.filter(function(a){return a.term_id===c.term_id})[0].term_id;d.push(f)}else{var g=a.terms.filter(function(a){return a.term_id===d[e-1]})[0].parent;d.push(g)}},f=c.level+1,g=0;0<=f;f--,g++)e(f,g);var h=d.reverse();this.scrollable?h.forEach(function(b,c){a.container.querySelector('.silo__item[data-id="'+b+'"]')&&a.container.querySelector('.silo__item[data-id="'+b+'"]').classList.add(a.opts.activeClass),a.displayLevel(c,b)}):(this.displayLevel(),this.container.querySelector('.silo__item[data-id="'+h[1]+'"]').classList.add(this.opts.activeClass),this.displayLevel(h.length-1,h[h.length-1]))}},{key:'handleClick',value:function handleClick(a){var b=a.target.parentNode;if(!this.preview&&b.classList.contains('silo__item')){if(0<b.dataset.childrens.length&&a.preventDefault(),b.classList.contains(this.opts.activeClass)){var g=parseInt(b.dataset.level);return this.removePrevRow(b,g),void this.handlePrevHistory(b)}var c=parseInt(b.dataset.level),d=parseInt(b.dataset.id),e=b.dataset.link,f=b.dataset.slug;this.removePrevRow(b,c),this.handleActiveClass(b),window.history.pushState(f,f,e),this.displayLevel(c+1,d)}}},{key:'handlePrevHistory',value:function handlePrevHistory(a){var b=this.terms.filter(function(b){return b.childrens.length&&b.childrens.includes(parseInt(a.dataset.id))})[0];b?window.history.pushState(b.slug,b.slug,b.term_link):window.history.pushState(this.baseSlug,this.baseSlug,window.location.protocol+'//'+window.location.host+'/'+this.baseSlug),this.scrollable&&(0,_utils.scrollIt)(a.parentNode,50,300)}},{key:'handleActiveClass',value:function handleActiveClass(a){var b=this,c=a.parentNode,d=c.querySelectorAll('.silo__item');d.forEach(function(a){return a.classList.remove(b.opts.activeClass)}),a.classList.add(this.opts.activeClass)}},{key:'removePrevRow',value:function removePrevRow(a){var b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:0,c=document.querySelectorAll('.silo__row');c.forEach(function(a){var c=a.dataset.level;c>b&&a.parentNode.removeChild(a)}),a.classList.remove(this.opts.activeClass)}},{key:'createRow',value:function createRow(){var a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:0,b=document.createElement('DIV');return b.classList.add('silo__row','silo__row--'+a),b.setAttribute('data-level',a),b}},{key:'displayLevel',value:function displayLevel(){var a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:0,b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:0,c=this.terms.filter(function(c){return c.level===a&&c.parent===b}),d=this.createRow(a),e=this.container.querySelector('.silo__row--'+(a-1));c.forEach(function(b){var c=document.createElement('DIV');c.setAttribute('data-level',a),c.setAttribute('data-childrens',b.childrens),c.setAttribute('data-id',b.term_id),c.setAttribute('data-slug',b.slug),c.setAttribute('data-link',b.term_link),c.classList.add('silo__item','silo__item--'+a),c.innerHTML='<a href="'+b.term_link+'">\n                        <span class="item__title">\n                          '+b.name+'\n                        </span>\n                      </a>',d.appendChild(c)}),!this.scrollable&&1<a&&e&&e.parentNode.removeChild(e),this.container.appendChild(d),0!==a&&'fadeIn'===this.opts.animation&&(0,_utils.fadeIn)(d),this.scrollable&&(0,_utils.scrollIt)(d,50,300)}},{key:'init',value:function init(){window.location.href!==window.location.protocol+'//'+window.location.host+'/'+this.baseSlug&&window.location.href!==window.location.protocol+'//'+window.location.host+'/'+this.baseSlug+'/'?this.checkUrl():this.displayLevel()}}]),a}();exports.default=Silo;
